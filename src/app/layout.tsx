...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/safari.png', sizes: 'any' },
      { url: '/safari.png', type: 'image/png' },
      { url: '/safari.png', sizes: '16x16', type: 'image/png' },
      { url: '/safari.png', sizes: '32x32', type: 'image/png' },
    ],
    apple: [
      { url: '/safari.png', sizes: '180x180', type: 'image/png' },
    ],
  },
